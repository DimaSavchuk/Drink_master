import{s as e,j as t,r as d,l as v,u as j,a as L,b,m as y,Q as w}from"./index-853f690c.js";import{g as k,a as I,d as D}from"./axiosConfig-31499234.js";const z=e.h1`
...
`,U=()=>t.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"89",height:"91",viewBox:"0 0 89 91",fill:"none",children:[t.jsx("path",{d:`M34.7168 90.9317C34.3738 90.9317 34.0449 90.7951 33.8024 90.5518C33.5599 
       ...
       34.2605L20.1301 34.3983C18.815 34.7275 17.4658 34.8942 16.1116 34.8947Z`,fill:"#F3F3F3",fillOpacity:"0.1"})]}),V=({data:x})=>{function l(i,o){const n=new Image;n.src=i,n.complete?o(!0):(n.onload=()=>{o(!0)},n.onerror=()=>{o(!1)})}return t.jsx(Z,{children:x.map(({title:i,measure:o,thumbMedium:n},c)=>{let s=null;return l(n,p=>{p?s=!0:s=!1}),t.jsxs("li",{children:[t.jsx(B,{children:s?t.jsx("img",{src:n||"http://res.cloudinary.com/dec1shvoo/image/upload/v1689169611/cocktails-v1/ingredient/Strawberries-Small.png",alt:i,loading:"lazy",style:{display:"block",width:"100%",height:"auto"}}):t.jsx(U,{})}),t.jsxs(M,{children:[t.jsx(X,{children:i}),t.jsx(O,{children:o||" "})]})]},c)})})},Q="/Drink_master/assets/coctails-mob-18ca057d.jpg",q="/Drink_master/assets/coctails-mob@2x-7b6104ad.jpg",G="/Drink_master/assets/coctails-tablet-9bb53f5b.jpg",J="/Drink_master/assets/coctails-tablet@2x-6bd5ea57.jpg",K="/Drink_master/assets/coctails-pc-0e4dd42f.jpg",N="/Drink_master/assets/coctails-pc@2x-4b5efb24.jpg",W=()=>t.jsxs("picture",{children:[t.jsx("source",{media:"(min-width: 1440px)",srcSet:`${K} 1x, ${N}`,type:"image/jpeg"}),t.jsx("source",{media:"(min-width: 768px)",srcSet:`${G} 1x, ${J} 2x`,type:"image/jpeg"}),t.jsx("img",{srcSet:q,src:Q,alt:"picture",loading:"lazy"})]}),Y=()=>{const[x,l]=d.useState(null),[i,o]=d.useState(""),[n,c]=d.useState(!0),[s,p]=d.useState(!1),[m,h]=d.useState(null),{drinkId:g}=v();return d.useEffect(()=>{const f=new AbortController;(async()=>{try{c(!0),p(!1);const{data:a,idCurrentUser:u}=await k(g,f);o(u),l(...a),h(a[0].favorites.includes(u))}catch(a){p(a.message)}finally{c(!1),f.abort()}})()},[g]),{drinkInfo:x,userId:i,isLoading:n,error:s,isfavorite:m,setIsFavorite:h}},i1=()=>{const x=j(),l=L();d.useEffect(()=>{l(b(x.pathname))},[l]);const{drinkInfo:i,userId:o,isLoading:n,error:c,isfavorite:s,setIsFavorite:p}=Y(),{drinkId:m}=v();function h(r){var a;p((a=r==null?void 0:r.favorites)==null?void 0:a.includes(o))}async function g(){const r=await I(m);r&&w.success("Added to favorites"),h(r)}async function f(){const r=await D(m);r&&w.success("Deleted from favorites"),h(r)}return t.jsxs(F,{children:[c&&t.jsx("h1",{children:"Error!!!"}),n&&t.jsx(y,{bgc:"var(--loader-background-color-without-opacity)"}),i&&t.jsxs(t.Fragment,{children:[t.jsxs(H,{children:[t.jsxs("div",{children:[t.jsx(z,{children:i.drink}),t.jsxs(S,{children:[i.glass," / ",i.alcoholic]}),t.jsx(E,{children:i.description}),s?t.jsx(C,{type:"button",onClick:f,children:"Remove from favorites"}):t.jsx(C,{type:"button",onClick:g,children:"Add to favorite drinks"})]}),t.jsx(T,{children:t.jsx("img",{src:i.drinkThumb,alt:i.drink,style:{display:"block",width:"100%",height:"auto"}})})]}),t.jsx(R,{children:"Ingredients"}),t.jsx(V,{data:i.ingredients}),t.jsx(A,{children:"Recipe Preparation"}),t.jsxs(P,{children:[t.jsx(_,{children:i.instructions}),t.jsx($,{children:t.jsx(W,{})})]})]})]})};export{i1 as default};
