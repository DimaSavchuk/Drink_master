...
`,DF=e=>e.filters.categories,IF=e=>e.filters.ingredients,X4=e=>e.filters.isLoading;var G4="Expected a function",rb=0/0,MF="[object Symbol]",LF=/^\s+|\s+$/g,FF=/^[-+]0x[0-9a-f]+$/i,zF=/^0b[01]+$/i,BF=/^0o[0-7]+$/i,UF=parseInt,WF=typeof nr=="object"&&nr&&nr.Object===Object&&nr,HF=typeof self=="object"&&self&&self.Object===Object&&self,VF=WF||HF||Function("return this")(),YF=Object.prototype,KF=YF.toString,XF=Math.max,GF=Math.min,t0=function(){return VF.Date.now()};function QF(e,t,n){var r,i,o,a,s,l,c=0,u=!1,f=!1,d=!0;if(typeof e!="function")throw new TypeError(G4);t=ib(t)||0,nf(n)&&(u=!!n.leading,f="maxWait"in n,o=f?XF(ib(n.maxWait)||0,t):o,d="trailing"in n?!!n.trailing:d);function h(_){var E=r,O=i;return r=i=void 0,c=_,a=e.apply(O,E),a}function v(_){return c=_,s=setTimeout(y,t),u?h(_):a}function m(_){var E=_-l,O=_-c,I=t-E;return f?GF(I,o-O):I}function w(_){var E=_-l,O=_-c;return l===void 0||E>=t||E<0||f&&O>=o}function y(){var _=t0();if(w(_))return g(_);s=setTimeout(y,m(_))}function g(_){return s=void 0,d&&r?h(_):(r=i=void 0,a)}function x(){s!==void 0&&clearTimeout(s),c=0,r=l=i=s=void 0}function k(){return s===void 0?a:g(t0())}function T(){var _=t0(),E=w(_);if(r=arguments,i=this,l=_,E){if(s===void 0)return v(l);if(f)return s=setTimeout(y,t),h(l)}return s===void 0&&(s=setTimeout(y,t)),a}return T.cancel=x,T.flush=k,T}function qF(e,t,n){var r=!0,i=!0;if(typeof e!="function")throw new TypeError(G4);return nf(n)&&(r="leading"in n?!!n.leading:r,i="trailing"in n?!!n.trailing:i),QF(e,t,{leading:r,maxWait:t,trailing:i})}function nf(e){var t=typeof e;return!!e&&(t=="object"||t=="function")}function JF(e){return!!e&&typeof e=="object"}function ZF(e){return typeof e=="symbol"||JF(e)&&KF.call(e)==MF}function ib(e){if(typeof e=="number")return e;if(ZF(e))return rb;if(nf(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=nf(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=e.replace(LF,"");var n=zF.test(e);return n||BF.test(e)?UF(e.slice(2),n?2:8):FF.test(e)?rb:+e}var ez=qF;const tz=Ai(ez),nz=({handleSelect:e,height:t,items:n})=>{const r=It(X4),[i,o]=b.useState(""),[a,s]=b.useState([]);b.useEffect(()=>{s(n)},[n]);const l=tz(c=>{const u=c.target.value;o(u);const f=n.filter(d=>d.toLowerCase().includes(u.toLowerCase()));s(f)},500);return p.jsx(NF,{onClick:e,height:t,children:r?p.jsx(PF,{children:"Loading..."}):p.jsxs(p.Fragment,{children:[p.jsx(AF,{children:p.jsx(RF,{value:i,onChange:l,placeholder:"Search..."})}),a.map(c=>p.jsx("li",{children:p.jsx($F,{children:c})},c))]})})},rz=$.svg`
    width: 20px;
    height: 20px;
    transition: all .2s ease;
    transform: ${({open:e})=>e?"rotate(0deg)":"rotate(180deg)"};
`,Q4=({isOpen:e})=>p.jsx(rz,{open:e,children:p.jsx("use",{href:`${Qt}#icon-chevron-down`})}),iz=$.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding: 18px 24px;
...
`,az=({handleControlClick:e,selectedOption:t,isOpen:n})=>p.jsxs(iz,{onClick:e,children:[p.jsx(oz,{children:t}),p.jsx(Q4,{isOpen:n})]}),ob=({items:e,placeholder:t,height:n,onSelect:r})=>{const[i,o]=b.useState(t),[a,s]=b.useState(!1),l=b.useRef(null),c=()=>{s(f=>!f)},u=f=>{f.target.tagName==="BUTTON"&&(o(f.target.textContent),r(f.target.textContent),c())};return b.useEffect(()=>{const f=d=>{l.current&&!l.current.contains(d.target)&&s(!1)};return document.addEventListener("click",f),()=>{document.removeEventListener("click",f)}},[]),p.jsxs(jF,{ref:l,children:[p.jsx(az,{handleControlClick:c,selectedOption:i,isOpen:a}),a&&p.jsx(nz,{handleSelect:u,height:n,items:e})]})},sz=$.div`
  display: flex;
  flex-direction: column;
  gap: 14px;
  margin-top: 40px;
...
`,h1=({limit:e,currentPage:t,itemsLength:n,handlePageChange:r,pageRangeDisplayed:i})=>{const o=Math.ceil(n/e),a=({selected:s})=>{r(s),window.scrollTo({top:0,behavior:"smooth"})};return p.jsx("div",{children:p.jsx(yz,{previousLabel:p.jsx(ab,{children:p.jsx("use",{href:`${Qt}#icon-paginateLeft`})}),nextLabel:p.jsx(ab,{children:p.jsx("use",{href:`${Qt}#icon-paginateRight`})}),pageCount:o,onPageChange:a,forcePage:t,renderOnZeroPageCount:null,breakLabel:"...",pageRangeDisplayed:i,marginPagesDisplayed:1})})},vz=e=>e.cocktails.cocktails,xz=e=>e.cocktails.totalCocktails,bz=e=>e.cocktails.isLoading,J4="/Drink_master/assets/asr_blue_iced_tea_mobile 1-cc1baafd.png",Z4="/Drink_master/assets/asr_blue_iced_tea_mobile@2x-ea88673c.png",wz=$.div`
  display: flex;
  justify-content: center;
  align-items: center;
`,kz=$.p`
  ...
  font-weight: 400;
  line-height: 1.42;
`,_d=({children:e})=>p.jsxs("div",{children:[p.jsx("picture",{children:p.jsx("img",{style:{margin:"0 auto"},src:J4,srcSet:`${Z4} 2x`,alt:"coctail",loading:"lazy"})}),p.jsx(wz,{children:p.jsx(kz,{children:e})})]}),Sz=$.section`
  overflow: hidden;
  max-width: 100%;
  padding-top: 152px;
  padding-bottom: 80px;
...
`],[`
  animation: `,` 0.75s steps(12, end) infinite;
  animation-duration: `,`s;
`])),pB,dB("speed","0.75"));Bl.polyline(Rb||(Rb=w1([`
  stroke-width: `,`px;
...
`,x6=(e,t,n,r)=>{if(e===0&&t>0){const i=t-1;n({page:i+1}),r(i)}},b6=({cardData:e,onDelete:t})=>{const{drink:n,description:r,alcoholic:i,_id:o,drinkThumb:a}=e,s=()=>window.matchMedia?window.matchMedia("only screen and (min-resolution: 192dpi)").matches:!1;return p.jsxs(xB,{children:[p.jsx("picture",{children:p.jsx(bB,{src:a,alt:"coctail",loading:"lazy",onError:l=>{l.target.src=s()?Y4:V4}})}),p.jsx(wB,{children:n}),p.jsx(kB,{children:i}),p.jsx(SB,{children:r}),p.jsxs(CB,{children:[p.jsx(EB,{to:`/drinks/${o}`,children:"See more"}),p.jsx(TB,{type:"button",id:o,onClick:()=>t(o),children:p.jsx(tN,{size:24})})]})]})},OB=async()=>{try{return(await Ze.get("/drinks/favorite")).data.data}catch(e){console.error("Помилка при отриманні даних:",e)}},w6=async e=>{try{return(await Ze.delete("/drinks/favorite/remove",{data:{recipeId:e}})).data.data}catch(t){console.error("Помилка при отриманні даних:",t)}},_B=async e=>{try{return(await Ze.post("/drinks/favorite/add",{recipeId:e})).data.data}catch(t){console.error("Помилка при отриманні даних:",t)}},jB=async(e,t)=>{const{data:n}=await Ze.get(`/drinks/${e}`,{signal:t.signal});return n},NB=async()=>{try{return(await Ze.get("/drinks/own")).data.data}catch(e){console.error("Помилка при отриманні даних:",e)}},$B=async e=>{try{return(await Ze.delete("/drinks/own/remove",{data:{recipeId:e}})).data.data}catch(t){console.error("Помилка при отриманні даних:",t)}},PB=async()=>{try{return(await Ze.get("/filters/categories")).data.categories}catch(e){console.error("Помилка при отриманні даних про категорії: ",e)}},AB=async()=>{try{return(await Ze.get("/filters/glasses")).data.glasses}catch(e){console.error("Помилка при отриманні даних про категорії: ",e)}},RB=async()=>{try{return(await Ze.get("/filters/ingredients")).data}catch(e){console.error("Помилка при отриманні даних про категорії: ",e)}},DB=async()=>{try{const e=await Ze.get("/drinks/popular");return console.log(e.data),e.data}catch(e){console.error("Помилка при отриманні даних: ",e)}},IB=async()=>{try{return(await Ze.get("/drinks/homepage")).data.data}catch(e){console.error("Помилка при отриманні даних на головну сторінку: ",e)}},MB=async e=>{const t=e.ingredients.map(({measure:i,title:o})=>{const a=JSON.parse(o);return{title:a.title,ingredientId:a._id,measure:i}}),n=JSON.stringify(t);let r=new FormData;r.append("cocktail",e.file),r.append("drink",e.title),r.append("category",e.category),r.append("alcoholic",e.alcoholicType),r.append("glass",e.glass),r.append("description",e.recipe),r.append("instructions",e.recipePreparation),r.append("ingredients",n),Ze.post("/drinks/own/add",r,{headers:{"Content-Type":"multipart/form-data"}}).then(i=>{console.log(i)}).catch(i=>{console.log(i)})},LB=(e,t,n)=>{const r=t.filter(i=>i._id!==e);n(r),w6(e)},FB=(e,t,n)=>{const r=t.filter(i=>i._id!==e);n(r),$B(e)},zB=(e,t,n,r)=>e.slice(t,t+n).map(i=>p.jsx("li",{children:p.jsx(b6,{cardData:i,onDelete:o=>LB(o,e,r)})},i._id)),BB=(e,t,n,r)=>e.slice(t,t+n).map(i=>p.jsx("li",{children:p.jsx(b6,{cardData:i,onDelete:o=>FB(o,e,r)})},i._id)),UB=async(e,t)=>{try{e(!0);const n=await OB();t(n),e(!1)}catch(n){console.log(n.message)}},WB=async(e,t)=>{try{e(!0);const n=await NB();t(n),e(!1)}catch(n){console.log(n.message)}},k6=(e,t,n)=>{t({page:e+1}),n(e)},xa=()=>{const e=window.innerWidth>=1440?9:(window.innerWidth>=768,8),t=window.innerWidth>=1440?6:3;return{newLimit:e,newPageRangeDisplayed:t}},S6=(e,t,n)=>{const r=t*n,i=r+n,o=e.slice(r,i),a=o.length;return{startIndex:r,endIndex:i,elementsOnPage:o,numberOfElementsOnPage:a}},HB=()=>{const[e,t]=b.useState([]),[n,r]=b.useState(!1),[i,o]=lf(),a=i.get("page")-1?Number(i.get("page")):0,[s,l]=b.useState(a),[c,u]=b.useState(null),[f,d]=b.useState(3),[h,v]=b.useState(!1);b.useEffect(()=>{UB(r,t)},[]);const m=s*c;b.useEffect(()=>{const{newLimit:g,newPageRangeDisplayed:x}=xa();return u(g),d(x),window.addEventListener("resize",xa),window.scrollTo({top:0,behavior:"smooth"}),()=>{window.removeEventListener("resize",xa)}},[]),b.useEffect(()=>{e.length>c?v(!0):v(!1)},[e.length,c]);const{numberOfElementsOnPage:w}=S6(e,s,c);b.useEffect(()=>{x6(w,s,o,l)},[w,s,o]);const y=zB(e,m,c,t);return p.jsx(g6,{children:p.jsx(Kr,{children:p.jsxs("div",{children:[p.jsx(y6,{children:"Favorites"}),n?p.jsx(bo,{}):e.length>0?p.jsxs(p.Fragment,{children:[p.jsx(v6,{children:y}),h&&p.jsx(h1,{limit:c,currentPage:s,itemsLength:e.length,handlePageChange:g=>k6(g,o,l),pageRangeDisplayed:f})]}):p.jsx(_d,{children:"You haven't added any favorite cocktails yet"})]})})})},VB=()=>{const e=Tn(),t=Yn();return b.useEffect(()=>{t(ts(e.pathname))},[t]),p.jsx(HB,{})},YB=()=>{const[e,t]=b.useState([]),[n,r]=b.useState(!1),[i,o]=lf(),a=i.get("page")?Number(i.get("page"))-1:0,[s,l]=b.useState(a),[c,u]=b.useState(null),[f,d]=b.useState(3),[h,v]=b.useState(!1);b.useEffect(()=>{WB(r,t)},[]);const m=s*c;b.useEffect(()=>{const{newLimit:g,newPageRangeDisplayed:x}=xa();return u(g),d(x),window.addEventListener("resize",xa),window.scrollTo({top:0,behavior:"smooth"}),()=>{window.removeEventListener("resize",xa)}},[]),b.useEffect(()=>{e.length>c?v(!0):v(!1)},[e.length,c]);const{numberOfElementsOnPage:w}=S6(e,s,c);b.useEffect(()=>{x6(w,s,o,l)},[w,s,o]);const y=BB(e,m,c,t);return p.jsx(g6,{children:p.jsx(Kr,{children:p.jsxs("div",{children:[p.jsx(y6,{children:"My drinks"}),n?p.jsx(bo,{}):e.length>0?p.jsxs(p.Fragment,{children:[p.jsx(v6,{children:y}),h&&p.jsx(h1,{limit:c,currentPage:s,itemsLength:e.length,handlePageChange:g=>k6(g,o,l),pageRangeDisplayed:f})]}):p.jsx(_d,{children:"You haven't added any own cocktails yet"})]})})})},KB=()=>{const e=Tn(),t=Yn();return b.useEffect(()=>{t(ts(e.pathname))},[t]),p.jsx(YB,{})},XB=mt.section`
  padding-top: 200px;
...
`,JB=()=>p.jsx(XB,{children:p.jsx(Kr,{children:p.jsxs("div",{style:{display:"flex",justifyContent:"center",alignItems:"center"},children:[p.jsx(GB,{children:"4"}),p.jsx("picture",{children:p.jsx(QB,{src:"./src/assets/hero/asr_blue_iced_tea_mobile 1.png",srcSet:"./src/assets/hero/asr_blue_iced_tea_mobile 1.png 1x, ./src/assets/hero/asr_blue_iced_tea_mobile@2x.png 2x",alt:"coctail",loading:"lazy"})}),p.jsx(qB,{children:"4"})]})})}),ZB="/Drink_master/assets/background380-29b49821.png",xc="/Drink_master/assets/background550-76772f6f.png",t2="/Drink_master/assets/background850-64ff8188.png",eU=$.div`
  width: 100%;
...
`,tU="/Drink_master/assets/Manrope-Bold-31e3e8e3.eot",nU="/Drink_master/assets/Manrope-Bold-31e3e8e3.eot?#iefix",rU="/Drink_master/assets/Manrope-Bold-04222367.woff2",iU="/Drink_master/assets/Manrope-Bold-eb62e902.woff",oU="/Drink_master/assets/Manrope-Bold-48afbde7.ttf",aU="/Drink_master/assets/Manrope-Semibold-b23ba1da.eot",sU="/Drink_master/assets/Manrope-Semibold-b23ba1da.eot?#iefix",lU="/Drink_master/assets/Manrope-Semibold-76b9cfa6.woff2",cU="/Drink_master/assets/Manrope-Semibold-76c853d8.woff",uU="/Drink_master/assets/Manrope-Semibold-381b52aa.ttf",fU="/Drink_master/assets/Manrope-Regular-aa79ff72.eot",dU="/Drink_master/assets/Manrope-Regular-aa79ff72.eot?#iefix",pU="/Drink_master/assets/Manrope-Regular-83d98918.woff2",mU="/Drink_master/assets/Manrope-Regular-2229b5ee.woff",hU="/Drink_master/assets/Manrope-Regular-2f7ad87a.ttf",gU="/Drink_master/assets/Manrope-Medium-dd8da55e.eot",yU="/Drink_master/assets/Manrope-Medium-dd8da55e.eot?#iefix",vU="/Drink_master/assets/Manrope-Medium-3407f3de.woff2",xU="/Drink_master/assets/Manrope-Medium-18de08bc.woff",bU="/Drink_master/assets/Manrope-Medium-f5530f03.ttf",wU=f7`
html {
  /* dark theme */
  &[data-theme='dark'] {
...
src: url(${tU});
    src: local('Manrope Bold'), local('Manrope-Bold'),
        url(${nU}) format('embedded-opentype'),
        url(${rU}) format('woff2'),
        url(${iU}) format('woff'),
        url(${oU}) format('truetype');
    font-weight: bold;
    font-style: normal;
}
...
@font-face {
  font-family: 'Manrope';
    ...
    src: local('Manrope Semibold'), local('Manrope-Semibold'),
        url(${sU}) format('embedded-opentype'),
        url(${lU}) format('woff2'),
        url(${cU}) format('woff'),
        url(${uU}) format('truetype');
    font-weight: 600;
    font-style: normal;
}
...
@font-face {
    ...
    src: local('Manrope Regular'), local('Manrope-Regular'),
        url(${dU}) format('embedded-opentype'),
        url(${pU}) format('woff2'),
        url(${mU}) format('woff'),
        url(${hU}) format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
@font-face {
    ...
    src: local('Manrope Medium'), local('Manrope-Medium'),
        url(${yU}) format('embedded-opentype'),
        url(${vU}) format('woff2'),
        url(${xU}) format('woff'),
        url(${bU}) format('truetype');
    font-weight: 500;
    font-style: normal;
}
...
`,PU=({children:e,navigateTo:t})=>p.jsx($U,{to:t,children:e}),AU=$.section`
  padding-bottom: 80px;
...
`,FU=({handleClick:e,children:t})=>p.jsx(LU,{type:"button",onClick:e,children:t}),zU=({numbCocktailsToShow:e})=>{const[t,n]=b.useState(!1),[r,i]=b.useState([]),[o,a]=b.useState(4),[s,l]=b.useState(!0);b.useEffect(()=>{(async()=>{n(!0);const f=await IB();if(!f){i([]),n(!1);return}i(f),n(!1)})()},[]);const c=()=>{a(r.length),l(!1)};return p.jsx(AU,{children:p.jsx(Kr,{children:t?p.jsx(bo,{}):r.length>0?p.jsxs("div",{children:[p.jsx(RU,{children:r.slice(0,o).map(u=>p.jsxs("li",{children:[p.jsx(DU,{children:u.category}),p.jsx(IU,{children:u.drinks.slice(0,e).map(f=>p.jsx("li",{children:p.jsx(K4,{data:f})},f.id))})]},zg()))}),p.jsxs(MU,{children:[s&&p.jsx(FU,{handleClick:c,children:"More categories"}),p.jsx(PU,{navigateTo:"/drinks",children:"Other drinks"})]})]}):p.jsx(_d,{children:"Some error occured."})})})},BU="/Drink_master/assets/motivation-7a7aa611.png";$.div`
  position: absolute;
  width: 500px;
  height: 500px;
  border-radius: 30px;
...
`;const UU=()=>{const e=Tn(),t=Yn();b.useEffect(()=>{t(ts(e.pathname))},[t]);const[n,r]=b.useState(1),i=()=>{window.innerWidth>=1440?r(3):window.innerWidth>=768?r(2):r(1)};return b.useEffect(()=>(i(),window.addEventListener("resize",i),()=>{window.removeEventListener("resize",i)}),[]),p.jsxs(p.Fragment,{children:[p.jsx(jU,{}),p.jsx(zU,{items:NU,numbCocktailsToShow:n})]})},WU=$.div`
  max-width: 375px;
  padding-top: 152px;
  padding-left: 20px;
  padding-right: 20px;
...
`;function QU(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M9.207 8.5l6.646 6.646-0.707 0.707-6.646-6.646-6.646 6.646-0.707-0.707 6.646-6.646-6.647-6.646 0.707-0.707 6.647 6.646 6.646-6.646 0.707 0.707-6.646 6.646z"}}]})(e)}function qU(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M15 8v1h-13v-1h13z"}}]})(e)}function C6(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M16 9h-7v7h-1v-7h-7v-1h7v-7h1v7h7v1z"}}]})(e)}function JU(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M6 8h-6v-6h1v4.109c1.013-3.193 4.036-5.484 7.5-5.484 3.506 0 6.621 2.36 7.574 5.739l-0.963 0.271c-0.832-2.95-3.551-5.011-6.611-5.011-3.226 0.001-6.016 2.276-6.708 5.376h4.208v1zM11 9v1h4.208c-0.693 3.101-3.479 5.375-6.708 5.375-3.062 0-5.78-2.061-6.611-5.011l-0.963 0.271c0.952 3.379 4.067 5.739 7.574 5.739 3.459 0 6.475-2.28 7.5-5.482v4.108h1v-6h-6z"}}]})(e)}const ZU=({ingredientsList:e})=>{const t={title:"",measure:""};return p.jsx(nM,{name:"ingredients",render:({form:{values:{ingredients:n}},push:r,remove:i})=>p.jsxs(VU,{children:[p.jsxs(YU,{children:[p.jsx("h3",{children:"Ingredients"}),p.jsxs(KU,{children:[p.jsx("button",{type:"button",onClick:()=>i(),children:p.jsx(qU,{size:16})}),p.jsx("span",{children:n.length?n.length:"0"}),p.jsx("button",{type:"button",onClick:()=>r(t),children:p.jsx(C6,{size:16})})]})]}),p.jsx("div",{children:n.length>0&&n.map((o,a)=>p.jsxs(XU,{role:"ingredientsSelect","aria-labelledby":"ingridientsSelect-group",children:[p.jsxs(GU,{children:[p.jsx(yo,{name:`ingredients.${a}.title`,as:"select",children:e&&e.map(s=>{const{title:l,_id:c}=s;return p.jsx("option",{value:JSON.stringify({title:l,_id:c}),children:s.title},s._id)})}),p.jsx("span",{children:p.jsx(qj,{size:18})})]}),p.jsx(yo,{name:`ingredients.${a}.measure`,placeholder:"1 cl"}),p.jsx("button",{type:"button",onClick:()=>i(a),children:p.jsx(QU,{size:18})})]},a))})]})})},eW=$.div`
  margin-bottom: 40px;
...
`,iW=$.span`
  ...
  border-radius: 6px;
  background-color: #f3f3f3;
`,oW=({setValue:e})=>{const[t,n]=b.useState(""),r=i=>{const o=i.currentTarget.files[0]??null,a=o?URL.createObjectURL(o):null;a&&(n(a),e("file",o))};return p.jsxs(eW,{children:[p.jsx("input",{type:"file",name:"file",id:"add-file",onChange:r}),p.jsx(nW,{children:p.jsxs("label",{htmlFor:"add-file",children:[t&&p.jsx(tW,{children:p.jsx("img",{id:"uploaded-file",src:t})}),p.jsxs(rW,{children:[p.jsx(iW,{children:t?p.jsx(JU,{size:16}):p.jsx(C6,{size:16})}),t?"Update file":"Add image"]})]})})]})},aW=mt.button`
  width: 100%;
  height: 34px;
  padding-bottom: 14px;
  padding-left: 0;
...
`,qm=mt.div`
  ...
  color: #da1414;
  text-align: right;
`,s2=({items:e,title:t,error:n})=>{const[r,i]=b.useState(!1),[o,a]=b.useState(""),[s,l]=b.useState(""),c=b.useRef(),u=b.useRef(),f=b.useRef(),d=t.toLowerCase(),h=y=>e.filter(g=>g.toLowerCase().includes(y.toLowerCase())),[,,{setValue:v}]=JI({name:d}),m=()=>{i(y=>!y)},w=y=>{a(y),m(),v(y),l("")};return b.useEffect(()=>{u&&(l(""),r&&u.current&&u.current.focus())},[r]),b.useEffect(()=>{const y=g=>{c.current&&c.current.contains(g.target)&&i(!0),f.current&&!f.current.contains(g.target)&&i(!1)};return window.addEventListener("click",y),()=>{window.removeEventListener("click",y)}}),p.jsxs(cW,{children:[p.jsxs(aW,{type:"button",ref:c,children:[p.jsx(sW,{children:t}),e&&p.jsxs("div",{style:{display:"flex"},children:[p.jsx("span",{children:o||""}),p.jsx(Q4,{isOpen:r})]})]}),r&&e&&p.jsx(p.Fragment,{children:p.jsxs(lW,{ref:f,children:[e.length>20&&p.jsx(fW,{ref:u,type:"text",name:`${t}Filter`,placeholder:"Search...",onChange:y=>l(y.target.value)}),h(s).map((y,g)=>p.jsx(uW,{onClick:()=>w(y),children:y},g))]})}),n?p.jsx(qm,{children:n}):null]})},hW=({categoriesList:e,glassesList:t,setValue:n,errors:r})=>p.jsxs(dW,{children:[p.jsx(oW,{setValue:n}),p.jsxs(pW,{children:[p.jsxs(r2,{children:[p.jsx(n2,{htmlFor:"title",children:"Enter item title"}),p.jsx(i2,{name:"title",placeholder:"Enter item title"}),r.title?p.jsx(qm,{children:r.title}):null]}),p.jsxs(r2,{children:[p.jsx(n2,{htmlFor:"recipe",children:"Enter about recipe"}),p.jsx(i2,{name:"recipe",placeholder:"Enter about recipe"}),r.recipe?p.jsx(qm,{children:r.recipe}):null]}),p.jsx(s2,{items:e,title:"Category",error:r.category}),p.jsx(s2,{items:t,title:"Glass",error:r.glass}),p.jsxs(mW,{role:"cocktailTypeSelect","aria-labelledby":"cocktailTypeSelect-group",children:[p.jsxs("div",{children:[p.jsx(a2,{type:"radio",name:"alcoholicType",id:"radioAlco",value:"Alcoholic"}),p.jsx(o2,{htmlFor:"radioAlco",children:"Alcoholic"})]}),p.jsxs("div",{children:[p.jsx(a2,{type:"radio",name:"alcoholicType",id:"radioNonAlco",value:"Non-alcoholic"}),p.jsx(o2,{htmlFor:"radioNonAlco",children:"Non-alcoholic"})]})]})]})]}),gW=$(yo)`
  /* display: block; */
  width: 100%;
  height: 184px;
  padding: 16px 18px;
...
`,xW=$.div`
  ...
  color: #da1414;
  text-align: left;
`,bW=({error:e,setValue:t})=>p.jsxs(vW,{children:[p.jsx("h3",{children:"Recipe Preparation"}),p.jsxs("div",{style:{position:"relative"},children:[p.jsx(gW,{name:"recipePreparation",placeholder:"Enter the recipe",onChange:n=>t("recipePreparation",n.target.value),as:"textarea"}),p.jsx(yW,{htmlFor:"recipePreparation",children:"Enter the recipe"})]}),e?p.jsx(xW,{children:e}):null]}),wW=$.div`
  @media (min-width: 1440px) {
    flex-basis: 67%;
    margin-right: 94px;
  }
...
`,SW=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await AB("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkGlasses:e,isLoading:n,error:i}},CW=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await PB("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkCategories:e,isLoading:n,error:i}},EW=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await RB("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkIngredients:e,isLoading:n,error:i}},TW=es({title:qt().trim().required("enter drink title"),recipe:qt().trim().required("enter about recipe"),category:qt().required("must have more than 1 item"),glass:qt().required("must have more than 1 item"),alcoholicType:qt().required("choose alcoholic type drink"),ingredients:_4().length(1,"must have more than 1 item").required()}),OW={title:"",recipe:"",category:"",glass:"",alcoholicType:"Non-alcoholic",ingredients:[],file:null,recipePreparation:""},_W=()=>{const e=(i,o)=>{i.id=zg(),MB(i),o.resetForm()},t=CW(),n=SW(),r=EW();return p.jsxs(wW,{children:[p.jsx("h2",{children:"Add drink"}),p.jsx(bd,{initialValues:OW,validationSchema:TW,onSubmit:e,children:({setFieldValue:i,errors:o})=>p.jsxs(wd,{children:[p.jsx(hW,{categoriesList:t.drinkCategories,glassesList:n.drinkGlasses,setValue:i,errors:o}),p.jsx(ZU,{ingredientsList:r.drinkIngredients}),p.jsx(bW,{setValue:i,error:o.recipePreparation}),p.jsx(kW,{type:"submit",children:"Add"})]})})]})},jW=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await DB("",a);t(l.data)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinksPopular:e,isLoading:n,error:i}},NW=$.div`
  margin-bottom: 28px;
...
`,$W=()=>{const{drinksPopular:e,isLoading:t,error:n}=jW(),r=3;return p.jsxs(NW,{children:[p.jsx("h4",{children:"Popular drinks"}),t&&p.jsx("div",{children:"Loading..."}),n&&p.jsx("div",{children:"error"}),e&&p.jsx("ul",{children:e.map(({drinkThumb:i,drink:o,description:a},s)=>{if(s<=r)return p.jsxs("li",{children:[p.jsx("img",{src:i,width:90,height:90}),p.jsxs("div",{children:[p.jsx("h6",{children:o}),p.jsx("p",{children:a})]})]},s)})})]})},PW=$.ul`
  display: flex;
  gap: 14px;
...
`,AW=()=>p.jsxs(PW,{children:[p.jsx("li",{children:p.jsx(i0,{target:"_blank",href:"https://www.facebook.com/goITclub/",children:p.jsx(Si,{size:"22px",size768:"28px",fill:"#f3f3f3",children:p.jsx("use",{href:`${Qt}#icon-facebook`})})})}),p.jsx("li",{children:p.jsx(i0,{target:"_blank",href:"https://www.instagram.com/goitclub/",children:p.jsx(Si,{size:"22px",size768:"28px",fill:"#f3f3f3",children:p.jsx("use",{href:`${Qt}#icon-instagram`})})})}),p.jsx("li",{children:p.jsx(i0,{target:"_blank",href:"https://www.youtube.com/c/GoIT",children:p.jsx(Si,{size:"22px",size768:"28px",fill:"#f3f3f3",children:p.jsx("use",{href:`${Qt}#icon-youtube`})})})})]}),RW=()=>p.jsxs("div",{children:[p.jsx("h4",{children:"Follow us"}),p.jsx(AW,{})]}),DW=()=>{const e=Tn(),t=Yn();return b.useEffect(()=>{t(ts(e.pathname))},[t]),p.jsxs(WU,{children:[p.jsx(_W,{}),p.jsxs(HU,{children:[p.jsx(RW,{}),p.jsx($W,{})]})]})},IW=$.h1`
  color: var(--text-color);
  font-size: 32px;
  font-style: normal;
  font-weight: 600;
...
`,JW=()=>p.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"89",height:"91",viewBox:"0 0 89 91",fill:"none",children:[p.jsx("path",{d:`M34.7168 90.9317C34.3738 90.9317 34.0449 90.7951 33.8024 90.5518C33.5599 
