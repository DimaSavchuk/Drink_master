...
`)),oj=wr("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),aj=wr(J_,{name:"MuiTouchRipple",slot:"Ripple"})(Lv||(Lv=cd`
  opacity: 0;
  position: absolute;
...
`,PF=e=>e.filters.categories,AF=e=>e.filters.ingredients,X4=e=>e.filters.isLoading;var G4="Expected a function",nb=0/0,RF="[object Symbol]",DF=/^\s+|\s+$/g,IF=/^[-+]0x[0-9a-f]+$/i,MF=/^0b[01]+$/i,LF=/^0o[0-7]+$/i,FF=parseInt,zF=typeof er=="object"&&er&&er.Object===Object&&er,BF=typeof self=="object"&&self&&self.Object===Object&&self,UF=zF||BF||Function("return this")(),WF=Object.prototype,HF=WF.toString,VF=Math.max,YF=Math.min,e0=function(){return UF.Date.now()};function KF(e,t,n){var r,i,o,a,s,l,c=0,u=!1,f=!1,d=!0;if(typeof e!="function")throw new TypeError(G4);t=rb(t)||0,tf(n)&&(u=!!n.leading,f="maxWait"in n,o=f?VF(rb(n.maxWait)||0,t):o,d="trailing"in n?!!n.trailing:d);function h(_){var E=r,T=i;return r=i=void 0,c=_,a=e.apply(T,E),a}function v(_){return c=_,s=setTimeout(y,t),u?h(_):a}function m(_){var E=_-l,T=_-c,I=t-E;return f?YF(I,o-T):I}function w(_){var E=_-l,T=_-c;return l===void 0||E>=t||E<0||f&&T>=o}function y(){var _=e0();if(w(_))return g(_);s=setTimeout(y,m(_))}function g(_){return s=void 0,d&&r?h(_):(r=i=void 0,a)}function x(){s!==void 0&&clearTimeout(s),c=0,r=l=i=s=void 0}function k(){return s===void 0?a:g(e0())}function O(){var _=e0(),E=w(_);if(r=arguments,i=this,l=_,E){if(s===void 0)return v(l);if(f)return s=setTimeout(y,t),h(l)}return s===void 0&&(s=setTimeout(y,t)),a}return O.cancel=x,O.flush=k,O}function XF(e,t,n){var r=!0,i=!0;if(typeof e!="function")throw new TypeError(G4);return tf(n)&&(r="leading"in n?!!n.leading:r,i="trailing"in n?!!n.trailing:i),KF(e,t,{leading:r,maxWait:t,trailing:i})}function tf(e){var t=typeof e;return!!e&&(t=="object"||t=="function")}function GF(e){return!!e&&typeof e=="object"}function QF(e){return typeof e=="symbol"||GF(e)&&HF.call(e)==RF}function rb(e){if(typeof e=="number")return e;if(QF(e))return nb;if(tf(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=tf(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=e.replace(DF,"");var n=MF.test(e);return n||LF.test(e)?FF(e.slice(2),n?2:8):IF.test(e)?nb:+e}var qF=XF;const JF=$i(qF),ZF=({handleSelect:e,height:t,items:n})=>{const r=Ht(X4),[i,o]=b.useState(""),[a,s]=b.useState([]);b.useEffect(()=>{s(n)},[n]);const l=JF(c=>{const u=c.target.value;o(u);const f=n.filter(d=>d.toLowerCase().includes(u.toLowerCase()));s(f)},500);return p.jsx(OF,{onClick:e,height:t,children:r?p.jsx(jF,{children:"Loading..."}):p.jsxs(p.Fragment,{children:[p.jsx(NF,{children:p.jsx($F,{value:i,onChange:l,placeholder:"Search..."})}),a.map(c=>p.jsx("li",{children:p.jsx(_F,{children:c})},c))]})})},ez=$.svg`
    width: 20px;
    height: 20px;
...
`,rz=({handleControlClick:e,selectedOption:t,isOpen:n})=>p.jsxs(tz,{onClick:e,children:[p.jsx(nz,{children:t}),p.jsx(Q4,{isOpen:n})]}),ib=({items:e,placeholder:t,height:n,onSelect:r})=>{const[i,o]=b.useState(t),[a,s]=b.useState(!1),l=b.useRef(null),c=()=>{s(f=>!f)},u=f=>{f.target.tagName==="BUTTON"&&(o(f.target.textContent),r(f.target.textContent),c())};return b.useEffect(()=>{const f=d=>{l.current&&!l.current.contains(d.target)&&s(!1)};return document.addEventListener("click",f),()=>{document.removeEventListener("click",f)}},[]),p.jsxs(TF,{ref:l,children:[p.jsx(rz,{handleControlClick:c,selectedOption:i,isOpen:a}),a&&p.jsx(ZF,{handleSelect:u,height:n,items:e})]})},iz=$.div`
  display: flex;
  flex-direction: column;
  gap: 14px;
  margin-top: 40px;
...
`,h1=({limit:e,currentPage:t,itemsLength:n,handlePageChange:r,pageRangeDisplayed:i})=>{const o=Math.ceil(n/e),a=({selected:s})=>{r(s),window.scrollTo({top:0,behavior:"smooth"})};return p.jsx("div",{children:p.jsx(mz,{previousLabel:p.jsx(ob,{children:p.jsx("use",{href:`${Qt}#icon-paginateLeft`})}),nextLabel:p.jsx(ob,{children:p.jsx("use",{href:`${Qt}#icon-paginateRight`})}),pageCount:o,onPageChange:a,forcePage:t,renderOnZeroPageCount:null,breakLabel:"...",pageRangeDisplayed:i,marginPagesDisplayed:1})})},Ll=()=>p.jsxs("div",{style:{color:"white",padding:"100px 50px",display:"flex",flexDirection:"column",alignItems:"center"},children:[p.jsx("h1",{style:{padding:"50px"},children:"We are looking for your drink..."}),p.jsx("svg",{id:"icon-drink",viewBox:"0 0 48 48",fill:"currentColor",width:"192",height:"192",children:p.jsx("path",{d:`M16 30v11c0 1.1-0.9 2-2 2l-5.5 0c-1.38 0-2.5 
...
`,r6=(e,t,n,r)=>{if(e===0&&t>0){const i=t-1;n({page:i+1}),r(i)}},Pz=({cardData:e,onDelete:t})=>{const{drink:n,description:r,alcoholic:i,_id:o,drinkThumb:a}=e,s=()=>window.matchMedia?window.matchMedia("only screen and (min-resolution: 192dpi)").matches:!1;return p.jsxs(Cz,{children:[p.jsx("picture",{children:p.jsx(Ez,{src:a,alt:"coctail",loading:"lazy",onError:l=>{l.target.src=s()?Y4:V4}})}),p.jsx(Tz,{children:n}),p.jsx(Oz,{children:i}),p.jsx(_z,{children:r}),p.jsxs(jz,{children:[p.jsx(Nz,{to:`/drinks/${o}`,children:"See more"}),p.jsx($z,{type:"button",id:o,onClick:()=>t(o),children:p.jsx(eN,{size:24})})]})]})},Az=async()=>{try{return(await rt.get("/drinks/favorite")).data.data}catch(e){console.error("Помилка при отриманні даних:",e)}},i6=async e=>{try{return(await rt.delete("/drinks/favorite/remove",{data:{recipeId:e}})).data.data}catch(t){console.error("Помилка при отриманні даних:",t)}},Rz=async e=>{try{return(await rt.post("/drinks/favorite/add",{recipeId:e})).data.data}catch(t){console.error("Помилка при отриманні даних:",t)}},Dz=async(e,t)=>{const{data:n}=await rt.get(`/drinks/${e}`,{signal:t.signal});return n},Iz=async()=>{try{return(await rt.get("/drinks/own")).data.data}catch(e){console.error("Помилка при отриманні даних:",e)}},Mz=async()=>{try{return(await rt.get("/filters/categories")).data.categories}catch(e){console.error("Помилка при отриманні даних про категорії: ",e)}},Lz=async()=>{try{return(await rt.get("/filters/glasses")).data.glasses}catch(e){console.error("Помилка при отриманні даних про категорії: ",e)}},Fz=async()=>{try{return(await rt.get("/filters/ingredients")).data}catch(e){console.error("Помилка при отриманні даних про категорії: ",e)}},zz=async()=>{try{const e=await rt.get("/drinks/popular");return console.log(e.data),e.data}catch(e){console.error("Помилка при отриманні даних: ",e)}},Bz=async()=>{try{return(await rt.get("/drinks/homepage")).data.data}catch(e){console.error("Помилка при отриманні даних на головну сторінку: ",e)}},Uz=async e=>{console.log(e);const t=JSON.stringify(e.ingredients);let n=new FormData;n.append("cocktail",e.file),n.append("drink",e.title),n.append("category",e.category),n.append("alcoholic",e.alcoholicType),n.append("glass",e.glass),n.append("description",e.recipe),n.append("instructions",e.recipePreparation),n.append("ingredients",t),rt.post("/drinks/own/add",n,{headers:{"Content-Type":"multipart/form-data"}}).then(r=>{console.log(r)}).catch(r=>{console.log(r)})},Wz=(e,t,n)=>{const r=t.filter(i=>i._id!==e);n(r),i6(e)},o6=(e,t,n,r)=>e.slice(t,t+n).map(i=>p.jsx("li",{children:p.jsx(Pz,{cardData:i,onDelete:o=>Wz(o,e,r)})},i._id)),Hz=async(e,t)=>{try{e(!0);const n=await Az();t(n),e(!1)}catch(n){console.log(n.message)}},Vz=async(e,t)=>{try{e(!0);const n=await Iz();t(n),e(!1)}catch(n){console.log(n.message)}},a6=(e,t,n)=>{t({page:e+1}),n(e)},va=()=>{const e=window.innerWidth>=1440?9:(window.innerWidth>=768,8),t=window.innerWidth>=1440?6:3;return{newLimit:e,newPageRangeDisplayed:t}},s6=(e,t,n)=>{const r=t*n,i=r+n,o=e.slice(r,i),a=o.length;return{startIndex:r,endIndex:i,elementsOnPage:o,numberOfElementsOnPage:a}},Yz=()=>{const[e,t]=b.useState([]),[n,r]=b.useState(!1),[i,o]=lf(),a=i.get("page")-1?Number(i.get("page")):0,[s,l]=b.useState(a),[c,u]=b.useState(null),[f,d]=b.useState(3),[h,v]=b.useState(!1);b.useEffect(()=>{Hz(r,t)},[]);const m=s*c;b.useEffect(()=>{const{newLimit:g,newPageRangeDisplayed:x}=va();return u(g),d(x),window.addEventListener("resize",va),window.scrollTo({top:0,behavior:"smooth"}),()=>{window.removeEventListener("resize",va)}},[]),b.useEffect(()=>{e.length>c?v(!0):v(!1)},[e.length,c]);const{numberOfElementsOnPage:w}=s6(e,s,c);b.useEffect(()=>{r6(w,s,o,l)},[w,s,o]);const y=o6(e,m,c,t);return p.jsx(e6,{children:p.jsx(Vr,{children:p.jsxs("div",{children:[p.jsx(t6,{children:"Favorites"}),n?p.jsx(Ll,{}):e.length>0?p.jsxs(p.Fragment,{children:[p.jsx(n6,{children:y}),h&&p.jsx(h1,{limit:c,currentPage:s,itemsLength:e.length,handlePageChange:g=>a6(g,o,l),pageRangeDisplayed:f})]}):p.jsx(Od,{children:"You haven't added any favorite cocktails yet"})]})})})},Kz=()=>p.jsx(Yz,{}),Xz=()=>{const[e,t]=b.useState([]),[n,r]=b.useState(!1),[i,o]=lf(),a=i.get("page")?Number(i.get("page"))-1:0,[s,l]=b.useState(a),[c,u]=b.useState(null),[f,d]=b.useState(3),[h,v]=b.useState(!1);b.useEffect(()=>{Vz(r,t)},[]);const m=s*c;b.useEffect(()=>{const{newLimit:g,newPageRangeDisplayed:x}=va();return u(g),d(x),window.addEventListener("resize",va),window.scrollTo({top:0,behavior:"smooth"}),()=>{window.removeEventListener("resize",va)}},[]),b.useEffect(()=>{e.length>c?v(!0):v(!1)},[e.length,c]);const{numberOfElementsOnPage:w}=s6(e,s,c);b.useEffect(()=>{r6(w,s,o,l)},[w,s,o]);const y=o6(e,m,c,t);return p.jsx(e6,{children:p.jsx(Vr,{children:p.jsxs("div",{children:[p.jsx(t6,{children:"My drinks"}),n?p.jsx(Ll,{}):e.length>0?p.jsxs(p.Fragment,{children:[p.jsx(n6,{children:y}),h&&p.jsx(h1,{limit:c,currentPage:s,itemsLength:e.length,handlePageChange:g=>a6(g,o,l),pageRangeDisplayed:f})]}):p.jsx(Od,{children:"You haven't added any own cocktails yet"})]})})})},Gz=()=>p.jsx(Xz,{}),Qz=mt.section`
  padding-top: 200px;
...
`,eB=()=>p.jsx(Qz,{children:p.jsx(Vr,{children:p.jsxs("div",{style:{display:"flex",justifyContent:"center",alignItems:"center"},children:[p.jsx(qz,{children:"4"}),p.jsx("picture",{children:p.jsx(Jz,{src:"./src/assets/hero/asr_blue_iced_tea_mobile 1.png",srcSet:"./src/assets/hero/asr_blue_iced_tea_mobile 1.png 1x, ./src/assets/hero/asr_blue_iced_tea_mobile@2x.png 2x",alt:"coctail",loading:"lazy"})}),p.jsx(Zz,{children:"4"})]})})}),tB="/Drink_master/assets/background380-29b49821.png",gc="/Drink_master/assets/background550-76772f6f.png",sb="/Drink_master/assets/background850-64ff8188.png",nB=$.div`
  width: 100%;
  background-image: url(${gc}), url(${gc});
  background-repeat: no-repeat;
  background-position:
    /* 60% 137%,
    20% 145%, */
  ...
  @media (min-width: 768px) {
    background-image: url(${sb}), url(${gc});
    background-position:
      /* 70% 132%,
      30% 138%, */
      200% -150px,
...
`,rB="/Drink_master/assets/Manrope-Bold-31e3e8e3.eot",iB="/Drink_master/assets/Manrope-Bold-31e3e8e3.eot?#iefix",oB="/Drink_master/assets/Manrope-Bold-04222367.woff2",aB="/Drink_master/assets/Manrope-Bold-eb62e902.woff",sB="/Drink_master/assets/Manrope-Bold-48afbde7.ttf",lB="/Drink_master/assets/Manrope-Semibold-b23ba1da.eot",cB="/Drink_master/assets/Manrope-Semibold-b23ba1da.eot?#iefix",uB="/Drink_master/assets/Manrope-Semibold-76b9cfa6.woff2",fB="/Drink_master/assets/Manrope-Semibold-76c853d8.woff",dB="/Drink_master/assets/Manrope-Semibold-381b52aa.ttf",pB="/Drink_master/assets/Manrope-Regular-aa79ff72.eot",mB="/Drink_master/assets/Manrope-Regular-aa79ff72.eot?#iefix",hB="/Drink_master/assets/Manrope-Regular-83d98918.woff2",gB="/Drink_master/assets/Manrope-Regular-2229b5ee.woff",yB="/Drink_master/assets/Manrope-Regular-2f7ad87a.ttf",vB="/Drink_master/assets/Manrope-Medium-dd8da55e.eot",xB="/Drink_master/assets/Manrope-Medium-dd8da55e.eot?#iefix",bB="/Drink_master/assets/Manrope-Medium-3407f3de.woff2",wB="/Drink_master/assets/Manrope-Medium-18de08bc.woff",kB="/Drink_master/assets/Manrope-Medium-f5530f03.ttf",SB=f7`
html {
  /* dark theme */
  &[data-theme='dark'] {
    --background-color: #0A0A11;
...
src: url(${rB});
    src: local('Manrope Bold'), local('Manrope-Bold'),
        url(${iB}) format('embedded-opentype'),
        url(${oB}) format('woff2'),
        url(${aB}) format('woff'),
        url(${sB}) format('truetype');
    font-weight: bold;
    font-style: normal;
}
...
@font-face {
  font-family: 'Manrope';
    ...
    src: local('Manrope Semibold'), local('Manrope-Semibold'),
        url(${cB}) format('embedded-opentype'),
        url(${uB}) format('woff2'),
        url(${fB}) format('woff'),
        url(${dB}) format('truetype');
    font-weight: 600;
    font-style: normal;
}
...
@font-face {
    ...
    src: local('Manrope Regular'), local('Manrope-Regular'),
        url(${mB}) format('embedded-opentype'),
        url(${hB}) format('woff2'),
        url(${gB}) format('woff'),
        url(${yB}) format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
`,AB=({children:e,navigateTo:t})=>p.jsx(PB,{to:t,children:e}),RB=$.section`
  padding-bottom: 80px;
...
`,zB=({handleClick:e,children:t})=>p.jsx(FB,{type:"button",onClick:e,children:t}),BB=({numbCocktailsToShow:e})=>{const[t,n]=b.useState(!1),[r,i]=b.useState([]),[o,a]=b.useState(4),[s,l]=b.useState(!0);b.useEffect(()=>{(async()=>{n(!0);const f=await Bz();if(!f){i([]),n(!1);return}i(f),n(!1)})()},[]);const c=()=>{a(r.length),l(!1)};return p.jsx(RB,{children:p.jsx(Vr,{children:t?p.jsx(Ll,{}):r.length>0?p.jsxs("div",{children:[p.jsx(DB,{children:r.slice(0,o).map(u=>p.jsxs("li",{children:[p.jsx(IB,{children:u.category}),p.jsx(MB,{children:u.drinks.slice(0,e).map(f=>p.jsx("li",{children:p.jsx(K4,{data:f})},f.id))})]},zg()))}),p.jsxs(LB,{children:[s&&p.jsx(zB,{handleClick:c,children:"More categories"}),p.jsx(AB,{navigateTo:"/drinks",children:"Other drinks"})]})]}):p.jsx(Od,{children:"Some error occured."})})})},UB="/Drink_master/assets/motivation-7a7aa611.png";$.div`
  position: absolute;
  width: 500px;
  height: 500px;
  border-radius: 30px;
...
`;const WB=()=>{const[e,t]=b.useState(1),n=()=>{window.innerWidth>=1440?t(3):window.innerWidth>=768?t(2):t(1)};return b.useEffect(()=>(n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),p.jsxs(p.Fragment,{children:[p.jsx(NB,{}),p.jsx(BB,{items:$B,numbCocktailsToShow:e})]})},HB=$.div`
  max-width: 375px;
  padding-top: 152px;
  padding-left: 20px;
  padding-right: 20px;
...
`;function qB(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M9.207 8.5l6.646 6.646-0.707 0.707-6.646-6.646-6.646 6.646-0.707-0.707 6.646-6.646-6.647-6.646 0.707-0.707 6.647 6.646 6.646-6.646 0.707 0.707-6.646 6.646z"}}]})(e)}function JB(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M15 8v1h-13v-1h13z"}}]})(e)}function l6(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M16 9h-7v7h-1v-7h-7v-1h7v-7h1v7h7v1z"}}]})(e)}function ZB(e){return fn({tag:"svg",attr:{version:"1.1",viewBox:"0 0 17 17"},child:[{tag:"g",attr:{},child:[]},{tag:"path",attr:{d:"M6 8h-6v-6h1v4.109c1.013-3.193 4.036-5.484 7.5-5.484 3.506 0 6.621 2.36 7.574 5.739l-0.963 0.271c-0.832-2.95-3.551-5.011-6.611-5.011-3.226 0.001-6.016 2.276-6.708 5.376h4.208v1zM11 9v1h4.208c-0.693 3.101-3.479 5.375-6.708 5.375-3.062 0-5.78-2.061-6.611-5.011l-0.963 0.271c0.952 3.379 4.067 5.739 7.574 5.739 3.459 0 6.475-2.28 7.5-5.482v4.108h1v-6h-6z"}}]})(e)}const eU=({ingredientsList:e})=>{const t={name:"",volume:""};return p.jsx(eM,{name:"ingredients",render:({form:{values:{ingredients:n}},push:r,insert:i,remove:o})=>p.jsxs(YB,{children:[p.jsxs(KB,{children:[p.jsx("h3",{children:"Ingredients"}),p.jsxs(XB,{children:[p.jsx("button",{type:"button",onClick:()=>o(),children:p.jsx(JB,{size:16})}),p.jsx("span",{children:n.length?n.length:"0"}),p.jsx("button",{type:"button",onClick:()=>r(t),children:p.jsx(l6,{size:16})})]})]}),p.jsx("div",{children:n.length>0&&n.map((a,s)=>p.jsxs(GB,{role:"ingredientsSelect","aria-labelledby":"ingridientsSelect-group",children:[p.jsxs(QB,{children:[p.jsx(ho,{name:`ingredients.${s}.name`,as:"select",children:e&&e.map(({title:l},c)=>p.jsx("option",{value:l,children:l},c))}),p.jsx("span",{style:{color:"#fff"},children:p.jsx(Qj,{size:18})})]}),p.jsx(ho,{name:`ingredients.${s}.volume`,placeholder:"1 cl"}),p.jsx("button",{type:"button",onClick:()=>o(s),children:p.jsx(qB,{size:18})})]},s))})]})})},tU=$.div`
  margin-bottom: 40px;
...
`,oU=$.span`
  ...
  border-radius: 6px;
  background-color: #f3f3f3;
`,aU=({setValue:e})=>{const[t,n]=b.useState(""),r=i=>{const o=i.currentTarget.files[0]??null,a=o?URL.createObjectURL(o):null;a&&(n(a),e("file",o))};return p.jsxs(tU,{children:[p.jsx("input",{type:"file",name:"file",id:"add-file",onChange:r}),p.jsx(rU,{children:p.jsxs("label",{htmlFor:"add-file",children:[t&&p.jsx(nU,{children:p.jsx("img",{id:"uploaded-file",src:t})}),p.jsxs(iU,{children:[p.jsx(oU,{children:t?p.jsx(ZB,{size:16}):p.jsx(l6,{size:16})}),t?"Update file":"Add image"]})]})})]})},sU=mt.button`
  width: 100%;
  height: 34px;
  padding-bottom: 14px;
  padding-left: 0;
...
`,Hm=mt.div`
  ...
  color: #da1414;
  text-align: right;
`,pb=({items:e,title:t,error:n})=>{const[r,i]=b.useState(!1),[o,a]=b.useState(""),[s,l]=b.useState(""),c=b.useRef(),u=b.useRef(),f=b.useRef(),d=t.toLowerCase(),h=y=>e.filter(g=>g.toLowerCase().includes(y.toLowerCase())),[,,{setValue:v}]=QI({name:d}),m=()=>{i(y=>!y)},w=y=>{a(y),m(),v(y),l("")};return b.useEffect(()=>{u&&(l(""),r&&u.current&&u.current.focus())},[r]),b.useEffect(()=>{const y=g=>{c.current&&c.current.contains(g.target)&&i(!0),f.current&&!f.current.contains(g.target)&&i(!1)};return window.addEventListener("click",y),()=>{window.removeEventListener("click",y)}}),p.jsxs(uU,{children:[p.jsxs(sU,{type:"button",ref:c,children:[p.jsx(lU,{children:t}),e&&p.jsxs("div",{style:{display:"flex"},children:[p.jsx("span",{children:o||""}),p.jsx(Q4,{isOpen:r})]})]}),r&&e&&p.jsx(p.Fragment,{children:p.jsxs(cU,{ref:f,children:[e.length>20&&p.jsx(dU,{ref:u,type:"text",name:`${t}Filter`,placeholder:"Search...",onChange:y=>l(y.target.value)}),h(s).map((y,g)=>p.jsx(fU,{onClick:()=>w(y),children:y},g))]})}),n?p.jsx(Hm,{children:n}):null]})},gU=({categoriesList:e,glassesList:t,setValue:n,errors:r})=>p.jsxs(pU,{children:[p.jsx(aU,{setValue:n}),p.jsxs(mU,{children:[p.jsxs(cb,{children:[p.jsx(lb,{htmlFor:"title",children:"Enter item title"}),p.jsx(ub,{name:"title",placeholder:"Enter item title"}),r.title?p.jsx(Hm,{children:r.title}):null]}),p.jsxs(cb,{children:[p.jsx(lb,{htmlFor:"recipe",children:"Enter about recipe"}),p.jsx(ub,{name:"recipe",placeholder:"Enter about recipe"}),r.recipe?p.jsx(Hm,{children:r.recipe}):null]}),p.jsx(pb,{items:e,title:"Category",error:r.category}),p.jsx(pb,{items:t,title:"Glass",error:r.glass}),p.jsxs(hU,{role:"cocktailTypeSelect","aria-labelledby":"cocktailTypeSelect-group",children:[p.jsxs("div",{children:[p.jsx(db,{type:"radio",name:"alcoholicType",id:"radioAlco",value:"Alcoholic"}),p.jsx(fb,{htmlFor:"radioAlco",children:"Alcoholic"})]}),p.jsxs("div",{children:[p.jsx(db,{type:"radio",name:"alcoholicType",id:"radioNonAlco",value:"Non-alcoholic"}),p.jsx(fb,{htmlFor:"radioNonAlco",children:"Non-alcoholic"})]})]})]})]}),yU=$(ho)`
  /* display: block; */
  width: 100%;
  height: 184px;
  padding: 16px 18px;
...
`,bU=$.div`
  ...
  color: #da1414;
  text-align: left;
`,wU=({error:e,setValue:t})=>p.jsxs(xU,{children:[p.jsx("h3",{children:"Recipe Preparation"}),p.jsxs("div",{style:{position:"relative"},children:[p.jsx(yU,{name:"recipePreparation",placeholder:"Enter the recipe",onChange:n=>t("recipePreparation",n.target.value),as:"textarea"}),p.jsx(vU,{htmlFor:"recipePreparation",children:"Enter the recipe"})]}),e?p.jsx(bU,{children:e}):null]}),kU=$.div`
  @media (min-width: 1440px) {
    flex-basis: 67%;
    margin-right: 94px;
  }
...
`,CU=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await Lz("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkGlasses:e,isLoading:n,error:i}},EU=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await Mz("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkCategories:e,isLoading:n,error:i}},TU=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await Fz("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkIngredients:e,isLoading:n,error:i}},OU=es({title:qt().trim().required("enter drink title"),recipe:qt().trim().required("enter about recipe"),category:qt().required("must have more than 1 item"),glass:qt().required("must have more than 1 item"),alcoholicType:qt().required("choose alcoholic type drink"),ingredients:_4().length(1,"must have more than 1 item").required()}),_U={title:"",recipe:"",category:"",glass:"",alcoholicType:"Non-alcoholic",ingredients:[],file:null,recipePreparation:""},jU=()=>{const e=(i,o)=>{console.log("SUBMIT"),i.id=zg(),Uz(i),o.resetForm()},t=EU(),n=CU(),r=TU();return p.jsxs(kU,{children:[p.jsx("h2",{children:"Add drink"}),p.jsx(xd,{initialValues:_U,validationSchema:OU,onSubmit:e,children:({setFieldValue:i,errors:o})=>p.jsxs(bd,{children:[p.jsx(gU,{categoriesList:t.drinkCategories,glassesList:n.drinkGlasses,setValue:i,errors:o}),p.jsx(eU,{ingredientsList:r.drinkIngredients}),p.jsx(wU,{setValue:i,error:o.recipePreparation}),p.jsx(SU,{type:"submit",children:"Add"})]})})]})},NU=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await zz("",a);t(l.data)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinksPopular:e,isLoading:n,error:i}},$U=$.div`
  margin-bottom: 28px;
...
`,PU=()=>{const{drinksPopular:e,isLoading:t,error:n}=NU(),r=3;return p.jsxs($U,{children:[p.jsx("h4",{children:"Popular drinks"}),t&&p.jsx("div",{children:"Loading..."}),n&&p.jsx("div",{children:"error"}),e&&p.jsx("ul",{children:e.map(({drinkThumb:i,drink:o,description:a},s)=>{if(s<=r)return p.jsxs("li",{children:[p.jsx("img",{src:i,width:90,height:90}),p.jsxs("div",{children:[p.jsx("h6",{children:o}),p.jsx("p",{children:a})]})]},s)})})]})},AU=$.ul`
  display: flex;
  gap: 14px;
...
`,RU=()=>p.jsxs(AU,{children:[p.jsx("li",{children:p.jsx(t0,{target:"_blank",href:"https://www.facebook.com/goITclub/",children:p.jsx(wi,{size:"22px",size768:"28px",fill:"#f3f3f3",children:p.jsx("use",{href:`${Qt}#icon-facebook`})})})}),p.jsx("li",{children:p.jsx(t0,{target:"_blank",href:"https://www.instagram.com/goitclub/",children:p.jsx(wi,{size:"22px",size768:"28px",fill:"#f3f3f3",children:p.jsx("use",{href:`${Qt}#icon-instagram`})})})}),p.jsx("li",{children:p.jsx(t0,{target:"_blank",href:"https://www.youtube.com/c/GoIT",children:p.jsx(wi,{size:"22px",size768:"28px",fill:"#f3f3f3",children:p.jsx("use",{href:`${Qt}#icon-youtube`})})})})]}),DU=()=>p.jsxs("div",{children:[p.jsx("h4",{children:"Follow us"}),p.jsx(RU,{})]}),IU=()=>p.jsxs(HB,{children:[p.jsx(jU,{}),p.jsxs(VB,{children:[p.jsx(DU,{}),p.jsx(PU,{})]})]}),MU=$.h1`
  color: var(--text-color);
  font-size: 32px;
  font-style: normal;
  font-weight: 600;
...
`,ZU=()=>p.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"89",height:"91",viewBox:"0 0 89 91",fill:"none",children:[p.jsx("path",{d:`M34.7168 90.9317C34.3738 90.9317 34.0449 90.7951 33.8024 90.5518C33.5599 
       ...
       34.2605L20.1301 34.3983C18.815 34.7275 17.4658 34.8942 16.1116 34.8947Z`,fill:"#F3F3F3",fillOpacity:"0.1"})]}),eW=({data:e})=>{function t(n,r){const i=new Image;i.src=n,i.complete?r(!0):(i.onload=()=>{r(!0)},i.onerror=()=>{r(!1)})}return p.jsx(XU,{children:e.map(({title:n,measure:r,thumbMedium:i},o)=>{let a=null;return t(i,s=>{s?a=!0:a=!1}),p.jsxs("li",{children:[p.jsx(GU,{children:a?p.jsx("img",{src:i||"http://res.cloudinary.com/dec1shvoo/image/upload/v1689169611/cocktails-v1/ingredient/Strawberries-Small.png",alt:n,loading:"lazy",style:{display:"block",width:"100%",height:"auto"}}):p.jsx(ZU,{})}),p.jsxs(QU,{children:[p.jsx(qU,{children:n}),p.jsx(JU,{children:r||" "})]})]},o)})})},tW="/Drink_master/assets/coctails-mob-18ca057d.jpg",nW="/Drink_master/assets/coctails-mob@2x-7b6104ad.jpg",rW="/Drink_master/assets/coctails-tablet-9bb53f5b.jpg",iW="/Drink_master/assets/coctails-tablet@2x-6bd5ea57.jpg",oW="/Drink_master/assets/coctails-pc-0e4dd42f.jpg",aW="/Drink_master/assets/coctails-pc@2x-4b5efb24.jpg",sW=()=>p.jsxs("picture",{children:[p.jsx("source",{media:"(min-width: 1440px)",srcSet:`${oW} 1x, ${aW}`,type:"image/jpeg"}),p.jsx("source",{media:"(min-width: 768px)",srcSet:`${rW} 1x, ${iW} 2x`,type:"image/jpeg"}),p.jsx("img",{srcSet:nW,src:tW,alt:"picture",loading:"lazy"})]}),lW=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(""),[i,o]=b.useState(!1),[a,s]=b.useState(!1),[l,c]=b.useState(null),{drinkId:u}=N2();return b.useEffect(()=>{const f=new AbortController;(async()=>{try{o(!0),s(!1);const{data:h,idCurrentUser:v}=await Dz(u,f);r(v),t(...h),c(h[0].favorites.includes(v))}catch(h){s(h.message)}finally{o(!1),f.abort()}})()},[u]),{drinkInfo:e,userId:n,isLoading:i,error:a,isfavorite:l,setIsFavorite:c}},cW=()=>{const{drinkInfo:e,userId:t,isLoading:n,error:r,isfavorite:i,setIsFavorite:o}=lW(),{drinkId:a}=N2();function s(u){var f;o((f=u==null?void 0:u.favorites)==null?void 0:f.includes(t))}async function l(){const u=await Rz(a);s(u)}async function c(){const u=await i6(a);s(u)}return p.jsxs(LU,{children:[r&&p.jsx("h1",{children:"Error!!!"}),n&&p.jsx(Ll,{}),e&&p.jsxs(p.Fragment,{children:[p.jsxs(FU,{children:[p.jsxs("div",{children:[p.jsx(MU,{children:e.drink}),p.jsxs(BU,{children:[e.glass," / ",e.alcoholic]}),p.jsx(UU,{children:e.description}),i?p.jsx(mb,{type:"button",onClick:c,children:"Remove from favorites"}):p.jsx(mb,{type:"button",onClick:l,children:"Add to favorite drinks"})]}),p.jsx(zU,{children:p.jsx("img",{src:e.drinkThumb,alt:e.drink,style:{display:"block",width:"100%",height:"auto"}})})]}),p.jsx(WU,{children:"Ingredients"}),p.jsx(eW,{data:e.ingredients}),p.jsx(HU,{children:"Recipe Preparation"}),p.jsxs(VU,{children:[p.jsx(YU,{children:e.instructions}),p.jsx(KU,{children:p.jsx(sW,{})})]})]})]})},hb=({component:e,redirectTo:t="/start"})=>Ht(T3)?p.jsx(A2,{to:t}):e,Mi=({component:e,redirectTo:t="/start"})=>{const n=Ht(T3),r=Ht(O3);return!n&&!r?p.jsx(A2,{to:t}):e},uW=$.div`
  position: fixed;
  z-index: 2000;
  top: 0;
  left: 0;
...
`;var dW={"aria-busy":!0,role:"status"},gb=globalThis&&globalThis.__assign||function(){return gb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},gb.apply(this,arguments)},yb=globalThis&&globalThis.__assign||function(){return yb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},yb.apply(this,arguments)},vb=globalThis&&globalThis.__assign||function(){return vb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},vb.apply(this,arguments)},xb=globalThis&&globalThis.__assign||function(){return xb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},xb.apply(this,arguments)},bb=globalThis&&globalThis.__assign||function(){return bb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},bb.apply(this,arguments)},wb=globalThis&&globalThis.__assign||function(){return wb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},wb.apply(this,arguments)},kb=globalThis&&globalThis.__assign||function(){return kb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},kb.apply(this,arguments)},c6={exports:{}},Xe={};/**
 * @license React
 * react-is.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
...
`])),Gn*.14,Gn,Gn*.11,Gn*.35,Gn,Gn*.35,Gn*.01,Gn,Gn*.99);zl.path($b||($b=S6([`
  stroke-dasharray: `,"px, ",`;
  stroke-dashoffset: 0;
...
`],[`
  ...
  stroke-dashoffset: 0;
  animation: `," ",`s linear infinite;
`])),Gn*.01,Gn,QW,GW);var Nb,$b,Pb=globalThis&&globalThis.__assign||function(){return Pb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Pb.apply(this,arguments)},Ab=globalThis&&globalThis.__assign||function(){return Ab=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Ab.apply(this,arguments)},Rb=globalThis&&globalThis.__assign||function(){return Rb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Rb.apply(this,arguments)},Db=globalThis&&globalThis.__assign||function(){return Db=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Db.apply(this,arguments)},Ib=globalThis&&globalThis.__assign||function(){return Ib=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Ib.apply(this,arguments)},Mb=globalThis&&globalThis.__assign||function(){return Mb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Mb.apply(this,arguments)},Lb=globalThis&&globalThis.__assign||function(){return Lb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Lb.apply(this,arguments)},qW=function(t,n){return function(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(typeof r[t]<"u")return r[t];if(t&&t.indexOf(".")>0){for(var i=t.split("."),o=i.length,a=r[i[0]],s=1;a!=null&&s<o;)a=a[i[s]],s+=1;if(typeof a<"u")return a}return n}},w1=globalThis&&globalThis.__makeTemplateObject||function(e,t){return Object.defineProperty?Object.defineProperty(e,"raw",{value:t}):e.raw=t,e},Fb=globalThis&&globalThis.__assign||function(){return Fb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Fb.apply(this,arguments)},JW=b1(zb||(zb=w1([`
 to {
...
`],[`
  animation: `,` 0.75s steps(12, end) infinite;
  animation-duration: `,`s;
`])),JW,qW("speed","0.75"));zl.polyline(Ub||(Ub=w1([`
  stroke-width: `,`px;
...
`])),function(e){return e.width});var zb,Bb,Ub,Wb=globalThis&&globalThis.__assign||function(){return Wb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Wb.apply(this,arguments)},Hb=globalThis&&globalThis.__assign||function(){return Hb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Hb.apply(this,arguments)},Vb=globalThis&&globalThis.__assign||function(){return Vb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Vb.apply(this,arguments)},k1=globalThis&&globalThis.__makeTemplateObject||function(e,t){return Object.defineProperty?Object.defineProperty(e,"raw",{value:t}):e.raw=t,e},Yb=globalThis&&globalThis.__assign||function(){return Yb=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},Yb.apply(this,arguments)},ZW=b1(Kb||(Kb=k1([`
 to {
