...
`,Xt="/Drink_master/assets/sprite-095dbc9e.svg",dt={HOME:"/",DRINKS:"/drinks",MYDRINKS:"/mydrinks",ADDDRINK:"/adddrink",ABOUTDRINK:"/drinks/:drinkId",FAVORITE:"/favorites",START:"/start",REGISTRATION:"/registration",LOGIN:"/login",ERROR:"*",DROPDOWN:"/dropdown"},Z8=_.ul`
  display: flex;
  align-items: center;
  gap: 16px;
...
`,n0=ft.div`
  ...
  color: #da1414;
  text-align: right;
`,ux=({items:e,title:t,error:n})=>{const[r,i]=b.useState(!1),[o,a]=b.useState(""),[s,l]=b.useState(""),c=b.useRef(),u=b.useRef(),f=b.useRef(),d=t.toLowerCase(),h=y=>e.filter(g=>g.toLowerCase().includes(y.toLowerCase())),[,,{setValue:v}]=gD({name:d}),m=()=>{i(y=>!y)},S=y=>{a(y),m(),v(y),l("")};return b.useEffect(()=>{u&&(l(""),r&&u.current&&u.current.focus())},[r]),b.useEffect(()=>{const y=g=>{c.current&&c.current.contains(g.target)&&i(!0),f.current&&!f.current.contains(g.target)&&i(!1)};return window.addEventListener("click",y),()=>{window.removeEventListener("click",y)}}),p.jsxs(PF,{children:[p.jsxs(OF,{type:"button",ref:c,children:[p.jsx(jF,{children:t}),e&&p.jsxs("div",{style:{display:"flex"},children:[p.jsx("span",{children:o||""}),p.jsx(Y3,{isOpen:r})]})]}),r&&e&&p.jsx(p.Fragment,{children:p.jsxs(NF,{ref:f,children:[e.length>20&&p.jsx($F,{ref:u,type:"text",name:`${t}Filter`,placeholder:"Search...",onChange:y=>l(y.target.value)}),h(s).map((y,g)=>p.jsx(_F,{onClick:()=>S(y),children:y},g))]})}),n?p.jsx(n0,{children:n}):null]})},MF=({categoriesList:e,glassesList:t,setValue:n,errors:r})=>p.jsxs(AF,{children:[p.jsx(TF,{setValue:n}),p.jsxs(DF,{children:[p.jsxs(ax,{children:[p.jsx(ox,{htmlFor:"title",children:"Enter item title"}),p.jsx(sx,{name:"title",placeholder:"Enter item title"}),r.title?p.jsx(n0,{children:r.title}):null]}),p.jsxs(ax,{children:[p.jsx(ox,{htmlFor:"recipe",children:"Enter about recipe"}),p.jsx(sx,{name:"recipe",placeholder:"Enter about recipe"}),r.recipe?p.jsx(n0,{children:r.recipe}):null]}),p.jsx(ux,{items:e,title:"Category",error:r.category}),p.jsx(ux,{items:t,title:"Glass",error:r.glass}),p.jsxs(RF,{role:"cocktailTypeSelect","aria-labelledby":"cocktailTypeSelect-group",children:[p.jsxs("div",{children:[p.jsx(cx,{type:"radio",name:"alcoholicType",id:"radioAlco",value:"Alcoholic"}),p.jsx(lx,{htmlFor:"radioAlco",children:"Alcoholic"})]}),p.jsxs("div",{children:[p.jsx(cx,{type:"radio",name:"alcoholicType",id:"radioNonAlco",value:"Non-alcoholic"}),p.jsx(lx,{htmlFor:"radioNonAlco",children:"Non-alcoholic"})]})]})]})]}),IF=_(io)`
  /* display: block; */
  width: 100%;
  height: 184px;
  padding: 16px 18px;
...
`,zF=_.div`
  ...
  color: #da1414;
  text-align: left;
`,BF=({error:e,setValue:t})=>p.jsxs(FF,{children:[p.jsx("h3",{children:"Recipe Preparation"}),p.jsxs("div",{style:{position:"relative"},children:[p.jsx(IF,{name:"recipePreparation",placeholder:"Enter the recipe",onChange:n=>t("recipePreparation",n.target.value),as:"textarea"}),p.jsx(LF,{htmlFor:"recipePreparation",children:"Enter the recipe"})]}),e?p.jsx(zF,{children:e}):null]}),UF=_.div`
  @media (min-width: 1440px) {
    flex-basis: 67%;
    margin-right: 94px;
  }
...
`,HF=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await cL("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkGlasses:e,isLoading:n,error:i}},VF=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await lL("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkCategories:e,isLoading:n,error:i}},YF=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await uL("",a);t(l)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinkIngredients:e,isLoading:n,error:i}},KF=Fa({title:Gt().trim().required("enter drink title"),recipe:Gt().trim().required("enter about recipe"),category:Gt().required("must have more than 1 item"),glass:Gt().required("must have more than 1 item"),alcoholicType:Gt().required("choose alcoholic type drink"),ingredients:S3().length(1,"must have more than 1 item").required()}),XF={title:"",recipe:"",category:"",glass:"",alcoholicType:"Non-alcoholic",ingredients:[],file:"",recipePreparation:""},GF=()=>{const e=(i,o)=>{i.id=Yh(),console.log(i),o.resetForm()},t=VF(),n=HF(),r=YF();return p.jsxs(UF,{children:[p.jsx("h2",{children:"Add drink"}),p.jsx(Hf,{initialValues:XF,validationSchema:KF,onSubmit:e,children:({setFieldValue:i,errors:o})=>p.jsxs(Vf,{children:[p.jsx(MF,{categoriesList:t.drinkCategories,glassesList:n.drinkGlasses,setValue:i,errors:o}),p.jsx(bF,{ingredientsList:r.drinkIngredients}),p.jsx(BF,{setValue:i,error:o.recipePreparation}),p.jsx(WF,{type:"submit",children:"Add"})]})})]})},QF=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,o]=b.useState(null);return b.useEffect(()=>{const a=new AbortController;(async()=>{try{r(!0);const l=await fL("",a);console.log(l.data),t(l.data)}catch(l){o(l.message)}finally{r(!1),a.abort()}})()},[]),{drinksPopular:e,isLoading:n,error:i}},qF=_.div`
  margin-bottom: 28px;
...
`,xz=()=>p.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"89",height:"91",viewBox:"0 0 89 91",fill:"none",children:[p.jsx("path",{d:`M34.7168 90.9317C34.3738 90.9317 34.0449 90.7951 33.8024 90.5518C33.5599 
       ...
       34.2605L20.1301 34.3983C18.815 34.7275 17.4658 34.8942 16.1116 34.8947Z`,fill:"#F3F3F3",fillOpacity:"0.1"})]}),bz=({data:e})=>{function t(n,r){const i=new Image;i.src=n,i.complete?r(!0):(i.onload=()=>{r(!0)},i.onerror=()=>{r(!1)})}return p.jsx(mz,{children:e.map(({title:n,measure:r,thumbMedium:i},o)=>{let a=null;return t(i,s=>{s?a=!0:a=!1}),p.jsxs("li",{children:[p.jsx(hz,{children:a?p.jsx("img",{src:i||"http://res.cloudinary.com/dec1shvoo/image/upload/v1689169611/cocktails-v1/ingredient/Strawberries-Small.png",alt:n,loading:"lazy",style:{display:"block",width:"100%",height:"auto"}}):p.jsx(xz,{})}),p.jsxs(gz,{children:[p.jsx(yz,{children:n}),p.jsx(vz,{children:r||" "})]})]},o)})})},wz="/Drink_master/assets/coctails-mob-18ca057d.jpg",kz="/Drink_master/assets/coctails-mob@2x-7b6104ad.jpg",Sz="/Drink_master/assets/coctails-tablet-9bb53f5b.jpg",Cz="/Drink_master/assets/coctails-tablet@2x-6bd5ea57.jpg",Ez="/Drink_master/assets/coctails-pc-0e4dd42f.jpg",Tz="/Drink_master/assets/coctails-pc@2x-4b5efb24.jpg",Oz=()=>p.jsxs("picture",{children:[p.jsx("source",{media:"(min-width: 1440px)",srcSet:`${Ez} 1x, ${Tz}`,type:"image/jpeg"}),p.jsx("source",{media:"(min-width: 768px)",srcSet:`${Sz} 1x, ${Cz} 2x`,type:"image/jpeg"}),p.jsx("img",{srcSet:kz,src:wz,alt:"picture",loading:"lazy"})]}),jz=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(""),[i,o]=b.useState(!1),[a,s]=b.useState(!1),[l,c]=b.useState(null),{drinkId:u}=Ax();return b.useEffect(()=>{const f=new AbortController;(async()=>{try{o(!0),s(!1);const{data:h,idCurrentUser:v}=await oL(u,f);r(v),t(...h),c(h[0].favorites.includes(v))}catch(h){s(h.message)}finally{o(!1),f.abort()}})()},[u]),{drinkInfo:e,userId:n,isLoading:i,error:a,isfavorite:l,setIsFavorite:c}},Nz=()=>{const{drinkInfo:e,userId:t,isLoading:n,error:r,isfavorite:i,setIsFavorite:o}=jz(),{drinkId:a}=Ax();function s(u){var f;o((f=u==null?void 0:u.favorites)==null?void 0:f.includes(t))}async function l(){const u=await iL(a);s(u)}async function c(){const u=await e4(a);s(u)}return p.jsxs(iz,{children:[r&&p.jsx("h1",{children:"Error!!!"}),n&&p.jsx(wl,{}),e&&p.jsxs(p.Fragment,{children:[p.jsxs(oz,{children:[p.jsxs("div",{children:[p.jsx(rz,{children:e.drink}),p.jsxs(sz,{children:[e.glass," / ",e.alcoholic]}),p.jsx(lz,{children:e.description}),i?p.jsx(fx,{type:"button",onClick:c,children:"Remove from favorites"}):p.jsx(fx,{type:"button",onClick:l,children:"Add to favorite drinks"})]}),p.jsx(az,{children:p.jsx("img",{src:e.drinkThumb,alt:e.drink,style:{display:"block",width:"100%",height:"auto"}})})]}),p.jsx(cz,{children:"Ingredients"}),p.jsx(bz,{data:e.ingredients}),p.jsx(uz,{children:"Recipe Preparation"}),p.jsxs(fz,{children:[p.jsx(dz,{children:e.instructions}),p.jsx(pz,{children:p.jsx(Oz,{})})]})]})]})},dx=({component:e,redirectTo:t="/"})=>In(oE)?p.jsx(C5,{to:t}):e,Pz="";function _z(){return e2(),console.log(Pz),p.jsxs(SL,{children:[p.jsx(HL,{}),p.jsx(Eu,{theme:"dark"}),p.jsxs(O5,{children:[p.jsx(fn,{path:"/start",element:p.jsx(mM,{})}),p.jsx(fn,{path:dt.REGISTRATION,element:p.jsx(dx,{redirectTo:dt.HOME,component:p.jsx(UM,{})})}),p.jsx(fn,{path:dt.LOGIN,element:p.jsx(dx,{redirectTo:dt.HOME,component:p.jsx(VM,{})})}),p.jsxs(fn,{path:dt.HOME,element:p.jsx(lM,{}),children:[p.jsx(fn,{index:!0,element:p.jsx(cF,{})}),p.jsx(fn,{path:dt.DRINKS,element:p.jsx(XI,{})}),p.jsx(fn,{path:dt.ABOUTDRINK,element:p.jsx(Nz,{})}),p.jsx(fn,{path:dt.ADDDRINK,element:p.jsx(nz,{})}),p.jsx(fn,{path:dt.MYDRINKS,element:p.jsx(gL,{})}),p.jsx(fn,{path:dt.FAVORITE,element:p.jsx(mL,{})}),p.jsx(fn,{path:"/dropdown",element:p.jsx(q2,{})}),p.jsx(fn,{path:dt.ERROR,element:p.jsx(wL,{})})]})]})]})}var wg="persist:",kg="persist/FLUSH",Zf="persist/REHYDRATE",Sg="persist/PAUSE",Cg="persist/PERSIST",Eg="persist/PURGE",Tg="persist/REGISTER",$z=-1;function Ac(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Ac=function(n){return typeof n}:Ac=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Ac(e)}function px(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function Az(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?px(n,!0).forEach(function(r){Dz(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):px(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function Dz(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Rz(e,t,n,r){r.debug;var i=Az({},n);return e&&Ac(e)==="object"&&Object.keys(e).forEach(function(o){o!=="_persist"&&t[o]===n[o]&&(i[o]=e[o])}),i}function Mz(e){var t=e.blacklist||null,n=e.whitelist||null,r=e.transforms||[],i=e.throttle||0,o="".concat(e.keyPrefix!==void 0?e.keyPrefix:wg).concat(e.key),a=e.storage,s;e.serialize===!1?s=function(j){return j}:typeof e.serialize=="function"?s=e.serialize:s=Iz;var l=e.writeFailHandler||null,c={},u={},f=[],d=null,h=null,v=function(j){Object.keys(j).forEach(function(O){y(O)&&c[O]!==j[O]&&f.indexOf(O)===-1&&f.push(O)}),Object.keys(c).forEach(function(O){j[O]===void 0&&y(O)&&f.indexOf(O)===-1&&c[O]!==void 0&&f.push(O)}),d===null&&(d=setInterval(m,i)),c=j};function m(){if(f.length===0){d&&clearInterval(d),d=null;return}var k=f.shift(),j=r.reduce(function(O,E){return E.in(O,k,c)},c[k]);if(j!==void 0)try{u[k]=s(j)}catch(O){console.error("redux-persist/createPersistoid: error serializing state",O)}else delete u[k];f.length===0&&S()}function S(){Object.keys(u).forEach(function(k){c[k]===void 0&&delete u[k]}),h=a.setItem(o,s(u)).catch(g)}function y(k){return!(n&&n.indexOf(k)===-1&&k!=="_persist"||t&&t.indexOf(k)!==-1)}function g(k){l&&l(k)}var x=function(){for(;f.length!==0;)m();return h||Promise.resolve()};return{update:v,flush:x}}function Iz(e){return JSON.stringify(e)}function Lz(e){var t=e.transforms||[],n="".concat(e.keyPrefix!==void 0?e.keyPrefix:wg).concat(e.key),r=e.storage;e.debug;var i;return e.deserialize===!1?i=function(a){return a}:typeof e.deserialize=="function"?i=e.deserialize:i=Fz,r.getItem(n).then(function(o){if(o)try{var a={},s=i(o);return Object.keys(s).forEach(function(l){a[l]=t.reduceRight(function(c,u){return u.out(c,l,s)},i(s[l]))}),a}catch(l){throw l}else return})}function Fz(e){return JSON.parse(e)}function zz(e){var t=e.storage,n="".concat(e.keyPrefix!==void 0?e.keyPrefix:wg).concat(e.key);return t.removeItem(n,Bz)}function Bz(e){}function mx(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function wr(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?mx(n,!0).forEach(function(r){Uz(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):mx(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function Uz(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Wz(e,t){if(e==null)return{};var n=Hz(e,t),r,i;if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(i=0;i<o.length;i++)r=o[i],!(t.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(n[r]=e[r])}return n}function Hz(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}var Vz=5e3;function Yz(e,t){var n=e.version!==void 0?e.version:$z;e.debug;var r=e.stateReconciler===void 0?Rz:e.stateReconciler,i=e.getStoredState||Lz,o=e.timeout!==void 0?e.timeout:Vz,a=null,s=!1,l=!0,c=function(f){return f._persist.rehydrated&&a&&!l&&a.update(f),f};return function(u,f){var d=u||{},h=d._persist,v=Wz(d,["_persist"]),m=v;if(f.type===Cg){var S=!1,y=function(T,R){S||(f.rehydrate(e.key,T,R),S=!0)};if(o&&setTimeout(function(){!S&&y(void 0,new Error('redux-persist: persist timed out for persist key "'.concat(e.key,'"')))},o),l=!1,a||(a=Mz(e)),h)return wr({},t(m,f),{_persist:h});if(typeof f.rehydrate!="function"||typeof f.register!="function")throw new Error("redux-persist: either rehydrate or register is not a function on the PERSIST action. This can happen if the action is being replayed. This is an unexplored use case, please open an issue and we will figure out a resolution.");return f.register(e.key),i(e).then(function(E){var T=e.migrate||function(R,D){return Promise.resolve(R)};T(E,n).then(function(R){y(R)},function(R){y(void 0,R)})},function(E){y(void 0,E)}),wr({},t(m,f),{_persist:{version:n,rehydrated:!1}})}else{if(f.type===Eg)return s=!0,f.result(zz(e)),wr({},t(m,f),{_persist:h});if(f.type===kg)return f.result(a&&a.flush()),wr({},t(m,f),{_persist:h});if(f.type===Sg)l=!0;else if(f.type===Zf){if(s)return wr({},m,{_persist:wr({},h,{rehydrated:!0})});if(f.key===e.key){var g=t(m,f),x=f.payload,k=r!==!1&&x!==void 0?r(x,u,g,e):g,j=wr({},k,{_persist:wr({},h,{rehydrated:!0})});return c(j)}}}if(!h)return t(u,f);var O=t(m,f);return O===m?u:c(wr({},O,{_persist:h}))}}function hx(e){return Gz(e)||Xz(e)||Kz()}function Kz(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function Xz(e){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)==="[object Arguments]")return Array.from(e)}function Gz(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}function gx(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function r0(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?gx(n,!0).forEach(function(r){Qz(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):gx(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function Qz(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var n4={registry:[],bootstrapped:!1},qz=function(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:n4,n=arguments.length>1?arguments[1]:void 0;switch(n.type){case Tg:return r0({},t,{registry:[].concat(hx(t.registry),[n.key])});case Zf:var r=t.registry.indexOf(n.key),i=hx(t.registry);return i.splice(r,1),r0({},t,{registry:i,bootstrapped:i.length===0});default:return t}};function Jz(e,t,n){var r=n||!1,i=Hh(qz,n4,t&&t.enhancer?t.enhancer:void 0),o=function(c){i.dispatch({type:Tg,key:c})},a=function(c,u,f){var d={type:Zf,payload:u,err:f,key:c};e.dispatch(d),i.dispatch(d),r&&s.getState().bootstrapped&&(r(),r=!1)},s=r0({},i,{purge:function(){var c=[];return e.dispatch({type:Eg,result:function(f){c.push(f)}}),Promise.all(c)},flush:function(){var c=[];return e.dispatch({type:kg,result:function(f){c.push(f)}}),Promise.all(c)},pause:function(){e.dispatch({type:Sg})},persist:function(){e.dispatch({type:Cg,register:o,rehydrate:a})}});return t&&t.manualPersist||s.persist(),s}var Og={},jg={};jg.__esModule=!0;jg.default=tB;function Dc(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Dc=function(n){return typeof n}:Dc=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Dc(e)}function yp(){}var Zz={getItem:yp,setItem:yp,removeItem:yp};function eB(e){if((typeof self>"u"?"undefined":Dc(self))!=="object"||!(e in self))return!1;try{var t=self[e],n="redux-persist ".concat(e," test");t.setItem(n,"test"),t.getItem(n),t.removeItem(n)}catch{return!1}return!0}function tB(e){var t="".concat(e,"Storage");return eB(t)?self[t]:Zz}Og.__esModule=!0;Og.default=iB;var nB=rB(jg);function rB(e){return e&&e.__esModule?e:{default:e}}function iB(e){var t=(0,nB.default)(e);return{getItem:function(r){return new Promise(function(i,o){i(t.getItem(r))})},setItem:function(r,i){return new Promise(function(o,a){o(t.setItem(r,i))})},removeItem:function(r){return new Promise(function(i,o){i(t.removeItem(r))})}}}var r4=void 0,oB=aB(Og);function aB(e){return e&&e.__esModule?e:{default:e}}var sB=(0,oB.default)("local");r4=sB;const lB=Vh({name:"filters",initialState:{categories:[],ingredients:[],isLoading:!1},extraReducers:e=>e.addCase(Zm.fulfilled,(t,n)=>{t.categories=n.payload,t.categories.unshift("All categories"),t.isLoading=!1}).addCase(Zm.pending,t=>{t.isLoading=!0}).addCase(e0.fulfilled,(t,n)=>{t.ingredients=n.payload,t.ingredients.unshift({title:"All ingredients"}),t.isLoading=!1}).addCase(e0.pending,t=>{t.isLoading=!0})}),cB=lB.reducer,uB=Vh({name:"cocktails",initialState:{cocktails:[],totalCocktails:0,isLoading:!1},extraReducers:e=>e.addCase($c.pending,t=>{t.isLoading=!0}).addCase($c.fulfilled,(t,n)=>{t.isLoading=!1,t.cocktails=n.payload.data,t.totalCocktails=n.payload.quantityTotal}).addCase($c.rejected,t=>{t.isLoading=!1,t.cocktails=[],t.totalCocktails=0})}),fB=uB.reducer,dB={key:"auth",storage:r4,whitelist:["token"]},i4=ZO({reducer:{auth:Yz(dB,CN),filters:cB,cocktails:fB},middleware:e=>e({serializableCheck:{ignoredActions:[kg,Zf,Sg,Cg,Eg,Tg]}})}),pB=Jz(i4);gm.createRoot(document.getElementById("root")).render(p.jsx(ye.StrictMode,{children:p.jsx(RC,{store:i4,children:p.jsx(Zw,{loading:null,persistor:pB,children:p.jsx(D5,{basename:"/Drink_master",children:p.jsx(_z,{})})})})}))});export default mB();
