...
import { Input, Item, Option, OptionsContainer, Text } from "./SelectOptions.styled"
...
export const SelectOptions = ({ handleSelect, height, items }) => {
    ...
    const handleInputChange = throttle((e) => {
        ...
        const filtered = items.filter(item => item.toLowerCase().includes(newValue.toLowerCase()));
